# Terraform Multi-AZ Infrastructure Automation
...
3. Click on an instance → **Node actions** → **Start terminal session**
...
The load balancer is ready, but won't serve traffic yet (no application installed).

**Note:** The instances won't pass health checks yet because there's no application running on port 80. That's expected! You'll fix this with Ansible in Lab 1.3.
...
**Keep this infrastructure running for Lab 1.3!**

You'll use Ansible to configure these instances in the next lab.
