...
- **Packer (Lab 2.2):** Build custom AMIs (EC2, AMI, snapshot operations)
- **Terraform (Lab 2.3):** Provision infrastructure (VPC, EC2, ALB, ASG, IAM)
- **Ansible (if used):** Discover instances and use SSM for configuration
