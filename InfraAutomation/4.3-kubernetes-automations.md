...
In this lab, we used `sed` in GitHub Actions to update the image tag in our deployment manifest. While this works, argocd offers a better image updater.
...
**Note:** Setting up Image Updater requires installing CRDs, updating Helm charts, creating image reflector objects, and configuring Git credentials. It's a more advanced topic beyond the scope of this lab, but worth exploring if you have time.
