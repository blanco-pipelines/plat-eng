# Lab 4.3: Blue/Green Deployments with Argo Rollouts
...
**Note:** If you completed Lab 3.2 (version injection), you can just tag and release without changing the code - the version will be injected automatically. If you didn't do that lab, use the code below:
