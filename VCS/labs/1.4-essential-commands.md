...
**⚠️ WARNING:** Never use `git reset` on commits you've already pushed to GitHub! It rewrites history and will cause problems for others. Use `git revert` instead for pushed commits.
