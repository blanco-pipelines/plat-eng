...
In Lab 2.3, you worked as **collaborators** - you had direct write access to each other's repositories.

**Forks are different:**

**Collaborator Workflow** (Lab 2.3):
...
Let's fork your partner's repository from Lab 2.3 (or any public repository).
...
### What's Different from Lab 2.3?

- In Lab 2.3, you created PRs **within** the same repository (from a branch)
