...
![Fork Repository with All Branches](images/fork-workflow-repo.png)
...
![GitHub Actions Running](images/actions-running.png)
...
![GitHub Actions Failing](images/actions-failing.png)
...
![Branch Protection with Status Checks](images/branch-protection-status-checks.png)
...
![Blocked PR Due to Failing Checks](images/blocked-pr-failing-checks.png)
...
![Successful PR with Passing Checks](images/successful-pr-passing-checks.png)
